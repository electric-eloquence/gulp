...
* Latest version (without Git):
  * `npm install https://github.com/electric-eloquence/gulp/tarball/v3-lts@3.9.6`
...
* Specific version (with Git):
  * `npm install electric-eloquence/gulp#3.9.6`
* Semver range (with Git):
  * `npm install electric-eloquence/gulp#semver:^3.9.6`
